...
filename = '/Users/biswadippaul/Projects/GETCO/117.247.83.101/3. Actual RE Gen/Gujarat_wind.csv'
...
table12 = petl.addfield(table11, 'POOL_TYPE', 'WIND', 1)
table13 = petl.addfield(table12, 'POOL_NAME', 'RE', 1)
# print table13
if table13:
    sql = """INSERT INTO `power`.`generation_staging2`
            (
            `datetime`,
            `pool_name`,
            `pool_type`,
